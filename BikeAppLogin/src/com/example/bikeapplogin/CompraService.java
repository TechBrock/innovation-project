...
public class CompraService extends AsyncTask<WebUsuario, Void, WebUsuario[]>{
	...
	private WebUsuario user;
		...
		public CompraService(Context ctx, String usr, String psw, String rqs, WebUsuario wus){
			this.cont = ctx;
			this.userLogin = usr;
			this.password = psw;
			this.requisicao = rqs;
